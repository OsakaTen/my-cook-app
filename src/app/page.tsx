      ...
      <section className="relative w-full min-h-screen">
        ...
        <div className="absolute top-[18.75rem] left-[9.375rem] text-amber-50 z-10 ">
          ...
          <div className="mt-5">
            ...
            <Link href="/inventory" className="ml-35 px-4 py-2 cursor-pointer text-2xl rounded-lg bg-red-400 text-white font-semibold ">在庫を追加</Link>
          </div>
        </div>
      </section>
      <main className=" mx-auto p-8 py-16">
        ...
        <section className="bg-gray-50 py-16 px-4 rounded-lg my-30">
          <div className="text-center">
            ...
            <Link href="/groups" className="bg-red-400 text-white px-8 py-3 rounded-full font-bold hover:bg-red-500 transition-colors text-lg">グループ機能を試す</Link>
          </div>
        </section>
